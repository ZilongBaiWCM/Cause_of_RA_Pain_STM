...
for(infla in unique_inflammation){
  ...
  #ggsave(plot = sp_ls.tsne, paste("/Users/baizilong/Documents/Dana-dataset/RA_paper/peac_validation_lowinf_pain_genes_summary_scores_vs_VAS_",infla,"_Fig2_nonpain.png",sep=""))
