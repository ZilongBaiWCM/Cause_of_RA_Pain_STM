...
#
coloring <- c('green', 'purple', 'orange', 'blue', 'blue', 'orange', 'orange', '#5A5A5A') # '#DC143C')
...
for(infla in unique_inflammation){
  ...
  ggsave(plot = sp_ls.tsne, 
         filename=paste("/Users/baizilong/Documents/Dana-dataset/RA_paper_updated/peac_validation_pain_genes_summary_scores_vs_VAS_",infla,"_Fig2_extended_v2.png",sep=""),
