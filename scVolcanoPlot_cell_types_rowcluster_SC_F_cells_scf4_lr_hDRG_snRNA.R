...
for (ctype in cell_types_levels) {
  ...
  fn <- paste(save_dir, 'DEA_',ctype,'_volcano_plot_figure3_scf4_genes_extended_hDRG_snRNA.png',sep="")
  ...
  write.csv(sorted_genes, paste(save_dir, 'DEA_',ctype,'_scf4_genes_sorted_genes_hDRG_snRNA.csv',sep=""))
  #dev.off()
}
