...
if __name__ == '__main__':
    ...
    pathotypes = ['lymphoid','myeloid','fibroidungraded', 'all','lymfibun', 'myefib', 'myefibun', 'lymmye']
    for patho in pathotypes:
        fn = 'pain_scores_peac_'+patho+'.csv'
        ...
        print(f"Pathotype: {patho}")
        print(f"Graph mean degree: {np.mean(np.sum(G,axis=1))}")
