...
if __name__ == '__main__':
    ...
    df_ps = pd.read_csv(data_dir + 'pain_scores_peac.csv', index_col=0)
    filter_condition = '_zscores_bulk_low_inflammatory_PEAC'
    ...
    g = G.flatten()
    fig = plt.hist(g)
    plt.savefig(save_dir+"peac_pain_score_similarity.png")
    print(g.sort())
    print(g)
