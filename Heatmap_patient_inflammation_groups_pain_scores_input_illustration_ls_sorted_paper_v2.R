...
annotation_colors = list(
  `Inflammation Level` = c(High="#5A5A5A", `Low (combined)`="orange"),
...
fn <- "Heatmap.low_inflammatory_genes_patients_pain_scores_inflammation_levels_ls_sorted_input_Fig2A_v2.png"
