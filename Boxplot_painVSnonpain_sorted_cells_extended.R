...
data=data.frame(cell_types_vec, pnp_vec ,  mean_zscore_vec)
...
fn <- "fig3b" #"Bulk Sorted Cell QC passed RA Tissue pain vs nonpain boxplots.png"

ggsave(filename = paste(save_dir, fn,vsep=""), plot = p, width = 6, height = 6, dpi = 300, device='png')
