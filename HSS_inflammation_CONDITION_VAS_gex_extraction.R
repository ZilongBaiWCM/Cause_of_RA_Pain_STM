...
redcap_data <- read_csv('rheumatoid_arthritis_redcap_raw_data.csv')

redcap_data <- data.frame(redcap_data)

idlist <- redcap_data$study_id
...
VAS_pain <- data$How.much.pain.have.you.had.because.of.your.condition.OVER.THE.PAST.WEEK..Please.indicate.how.severe.your.pain.has.been.
...
meta_pain_scores <- data[data$Study.ID %in% patient_IDs$Study.IDs,c('Study.ID','How.much.pain.have.you.had.because.of.your.condition.OVER.THE.PAST.WEEK..Please.indicate.how.severe.your.pain.has.been.')]

pain_scores <- meta_pain_scores$How.much.pain.have.you.had.because.of.your.condition.OVER.THE.PAST.WEEK..Please.indicate.how.severe.your.pain.has.been.
...
## Z-score
gex_highlow_pain <- gex_sorted[pain_genes, rownames(pain_scores)]
...
write.csv(gex_highlow_pain_zscore,paste('/Users/baizilong/Documents/Dana-dataset/Exploration-results/Paper_Gene-Expression_Low-Inflammatory-Synovium_Pain/InputData/GEX_zscores_bulk_pain815_all_HSS_CONDITION_VAS.csv',sep=''))

write.csv(pain_scores[colnames(gex_highlow_pain_zscore),],paste('/Users/baizilong/Documents/Dana-dataset/Exploration-results/Paper_Gene-Expression_Low-Inflammatory-Synovium_Pain/InputData/pain_scores_hss_condition_vas_all.csv',sep=''))
...
write.csv(gex_highinf_pain_zscore,paste('/Users/baizilong/Documents/Dana-dataset/Exploration-results/Paper_Gene-Expression_Low-Inflammatory-Synovium_Pain/InputData/GEX_zscores_bulk_pain815_highinf_HSS_CONDITION_VAS.csv',sep=''))

write.csv(pain_scores[high_inf,],paste('/Users/baizilong/Documents/Dana-dataset/Exploration-results/Paper_Gene-Expression_Low-Inflammatory-Synovium_Pain/InputData/pain_scores_hss_condition_vas_highinf.csv',sep=''))
...
write.csv(gex_lowinf_pain_zscore,paste('/Users/baizilong/Documents/Dana-dataset/Exploration-results/Paper_Gene-Expression_Low-Inflammatory-Synovium_Pain/InputData/GEX_zscores_bulk_pain815_lowinf_HSS_CONDITION_VAS.csv',sep=''))

write.csv(pain_scores[low_inf,],paste('/Users/baizilong/Documents/Dana-dataset/Exploration-results/Paper_Gene-Expression_Low-Inflammatory-Synovium_Pain/InputData/pain_scores_hss_condition_vas_lowinf.csv',sep=''))
