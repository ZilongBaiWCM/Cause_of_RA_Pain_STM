...
#Fist align the patient list according to the original REDCAP dataset.
...
write.csv(gex_highlow_pain_zscore,paste('/Users/baizilong/Documents/Dana-dataset/Exploration-results/Paper_Gene-Expression_Low-Inflammatory-Synovium_Pain/InputData/GEX_zscores_bulk_pain815_all_HSS_RA_VAS.csv',sep=''))

write.csv(pain_scores[colnames(gex_highlow_pain_zscore),],paste('/Users/baizilong/Documents/Dana-dataset/Exploration-results/Paper_Gene-Expression_Low-Inflammatory-Synovium_Pain/InputData/pain_scores_hss_ra_vas_all.csv',sep=''))
...
write.csv(gex_highinf_pain_zscore,paste('/Users/baizilong/Documents/Dana-dataset/Exploration-results/Paper_Gene-Expression_Low-Inflammatory-Synovium_Pain/InputData/GEX_zscores_bulk_pain815_highinf_HSS_RA_VAS.csv',sep=''))

write.csv(pain_scores[high_inf,],paste('/Users/baizilong/Documents/Dana-dataset/Exploration-results/Paper_Gene-Expression_Low-Inflammatory-Synovium_Pain/InputData/pain_scores_hss_ra_vas_highinf.csv',sep=''))
...
write.csv(gex_lowinf_pain_zscore,paste('/Users/baizilong/Documents/Dana-dataset/Exploration-results/Paper_Gene-Expression_Low-Inflammatory-Synovium_Pain/InputData/GEX_zscores_bulk_pain815_lowinf_HSS_RA_VAS.csv',sep=''))

write.csv(pain_scores[low_inf,],paste('/Users/baizilong/Documents/Dana-dataset/Exploration-results/Paper_Gene-Expression_Low-Inflammatory-Synovium_Pain/InputData/pain_scores_hss_ra_vas_lowinf.csv',sep=''))
