...
for(infla in unique_inflammation){
  ...
  ggsave(plot = sp_ls.tsne, paste("/Users/baizilong/Documents/Dana-dataset/RA_paper_updated/hss_validation_pain_genes_summary_scores_vs_HSS_CONDITION_VAS_",infla,"_Fig2_extended_v2.png",sep=""),
