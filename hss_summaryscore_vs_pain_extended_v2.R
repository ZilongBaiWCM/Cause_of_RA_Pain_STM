...
sp_ls.tsne + 
  ...
  labs(x=NULL, y=NULL)
ggsave(paste("/Users/baizilong/Documents/Dana-dataset/RA_paper_updated/hss_summary_scores_vs_pain_scores_highlowinfla_pain_genes_paper_Fig2_p11_v2",".png",sep=""),
...
sp_ls.tsne + 
  scale_y_continuous(limits=c(0, 60)) +  #name="HOOS/KOOS Pain Score", 
  labs(x=NULL, y=NULL)
ggsave(paste("/Users/baizilong/Documents/Dana-dataset/RA_paper_updated/hss_summary_scores_vs_pain_scores_highlowinfla_pain_genes_paper_Fig2_p7_v2",".png",sep=""),
       width = 7, height = 10, dpi = 300, units = "in", device='png')
#dev.off()
...
sp_ls.tsne<-ggplot(df.tsne, aes(x, y, label=ps)) +
  geom_point(aes(size=15), show.legend=FALSE,colour="#5A5A5A", size=7) +
  #geom_point(aes(size=10), show.legend=FALSE,colour="black") +
  geom_smooth(method = "lm", se = FALSE, color="black") +
  theme(#text = element_text(size = 30),
    #axis.text.x = element_text(size = 30),
...
sp_ls.tsne + 
  scale_y_continuous(limits=c(0, 60)) +  #name="HOOS/KOOS Pain Score", 
  labs(x=NULL, y=NULL)
ggsave(paste("/Users/baizilong/Documents/Dana-dataset/RA_paper_updated/hss_summary_scores_vs_pain_scores_highinfla_pain_genes_paper_Fig2_p3_v2",".png",sep=""),
       width = 7, height = 10, dpi = 300, units = "in", device='png')
#dev.off()
