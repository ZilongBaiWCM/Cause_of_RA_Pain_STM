...
fn <- "Heatmap.correlation_coefficient_ls_based_gene_prioritizations_single_patient_excluded_new_colorbar.pdf"
...
# fn <- "Heatmap.correlation_p.value_ls_based_gene_prioritizations_single_patient_excluded.png"
