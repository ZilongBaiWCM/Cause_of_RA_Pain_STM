...
pain_scores[pain_scores$Pathotype=='lymphoid' | pain_scores$Pathotype=='myeloid', 'Inflammation Level'] <- '1.High'
...
annotation_colors = list(
  ...
  `Inflammation Level` = c(`1.High`="#5A5A5A", `3.Low`="orange"),
...
fn <- "Heatmap.low_inflammatory_genes_patients_pain_scores_inflammation_levels_in_PEAC_Fig2G_2groups_v2.png"
